...
public class UserInfoServlet extends HttpServlet {
	...
	private void registerUserInfo(HttpServletRequest req,
		...
		// TODO Auto-generated method stub
		try {
			String u_imgurl =MyStringUtlis.toUTFString(req,"u_imgurl");
			...
			String u_address =MyStringUtlis.toUTFString(req,"u_address");

//			int u_address = Integer.parseInt(req.getParameter("u_address"));
			
			UserInfo userInfo = new UserInfo();
			userInfo.setU_imgurl(u_imgurl);
			userInfo.setU_phone(u_phone);
			userInfo.setU_password(u_password);
			userInfo.setU_name(u_name);
			userInfo.setU_address(u_address);
